                    ...
                    <div class="row">
                        ...
                        <h1 class="text-uppercase font-weight-bold font-size 100px  m-4 text-center">Модальные глаголы</h1>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item list-group-item-success text-center m-1"><em>You <strong>should</strong> follow your doctor’s advice!</em> — Тебе <strong>следует</strong> слушать советы доктора!</li>
                                <li class="list-group-item list-group-item-success text-center m-1"><em>She <strong>can’t</strong> swim so she isn’t coming with us to the river.</em> — Она <strong>не умеет</strong> плавать, поэтому она не идет с нами на реку.</li>
                                <li class="list-group-item list-group-item-success text-center m-1"><em>What languages <strong>can</strong> he speak?</em> — На каких языках он <strong>может</strong> говорить?</li>
                            </ul>
                            <h5 class="p m-2">Правила употребления модальных глаголов</h5>
                            <ul class="list-group">

                                <li class="list-group-item list-group-item-primary text-center">Модальный глагол всегда употребляется со смысловым глаголом, который стоит в начальной форме (<em>must do, could see</em>).</li>

                                <li class="list-group-item list-group-item-primary m-1 text-center">Модальные глаголы имеют одну форму во всех лицах и числах. Исключением будет лишь <em>have to</em>, который принимает форму <em>has</em> после местоимений <em>he, she, it</em>.</li>
                                <li class="list-group-item list-group-item-primary m-1 text-center">Модальные глаголы всегда стоят в настоящем времени (даже в контексте будущего времени), однако некоторые из них могут принимать прошедшую форму: <em>can — could; may — might, must — had to</em>.</li>
                                <li class="list-group-item list-group-item-primary m-1 text-center">В отрицательных и вопросительных предложениях модальные глаголы не употребляются со вспомогательными, за исключением <em>have to.</em></li>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item list-group-item-success text-center m-1"><em><strong>May</strong> I use your laptop?</em> — <strong>Могу</strong> я воспользоваться вашим ноутбуком.</li>
                            </ul>
                            ...
                            <li class="list-group-item list-group-item-danger text-center m-1" >Обратите внимание, что для соединения модального и смыслового глаголов не нужна частица <em>to</em>. За исключением <em>ought to</em> и <em>have to</em>, где <em>to</em> — часть модального глагола.</li>
                            </ul>
                        </div>
