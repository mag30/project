            ...
            <div>
                ...
                <div class=" about  ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h1 class="text-uppercase font-weight-bold font-size 100px  m-4 text-center">Simple Forms</h1>
                            ...
                            <h2 class="text-center">Present Simple</h2>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item list-group-item-primary text-center">Последовательные действия, например в сюжете книги или фильма</li>
                                <li class="list-group-item list-group-item-primary text-center">Для описания действия, которое происходит согласно определенному графику.</li>
                                ...
                                <li class="list-group-item list-group-item-success text-center"><em>They usually play tennis every weekend</em> — Они обычно играют в теннис каждые выходные.</li>
                                <li class="list-group-item list-group-item-success text-center"><em>She brings me coffee every morning</em> — Она приносит мне кофе каждое утро.</li>
                            ...
                            <h2 class="text-center">Present Continuous</h2>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item list-group-item-primary text-center"><em>Present Continuous</em> используется для описания длительных действий в настоящем, даже если они не происходят в момент речи. То есть на протяжении какого-то времени мы периодически выполняем это действие</li>
                                <li class="list-group-item list-group-item-primary text-center"><em>Present Continuous</em> используется для описания изменений, происходящих в какой-то ситуации, и процесса развития. В таких конструкциях действие часто передается глаголами <em>to get (становиться), to increase (увеличивать/увеличиваться), to decrease (уменьшать/уменьшаться), to rise (подниматься), to fall (падать), to start (начинать/начинаться), to change (менять/меняться)</em> и т. д.</li>
                                <li class="list-group-item list-group-item-primary text-center"><em>Present Continuous</em> может использоваться для обозначения событий ближайшего будущего, но только в том случае, если это касается запланированных действий.</li>
                                <p class="p">Например:</p>
                                ...
                                <li class="list-group-item list-group-item-success text-center"><em>Steve <strong>is watching</strong> TV at the moment</em>. — Сейчас Стив <strong>смотрит</strong> телевизор.</li>
                                <li class="list-group-item list-group-item-success text-center"><em>Jessica <strong>is learning</strong> French.</em> — Джессика <strong>учит</strong> французский. (<em>она занимается изучением французского уже какое-то время и будет продолжать учить его, но она не занята изучением французского прямо сейчас</em>)</li>


                            </ul>

                            <p class="text-center m-2"><img src='https://lh6.googleusercontent.com/TolerCmRBekE4qywc90YdA3YBaOasiNgQ6XfuCCUSdehxUtRDkheanEyW0jDoAoHge3ua1Fgc6gPpM45GBkf21aYFXidfaPjeJD-xyWqfaIq7zmkqV84zllvQHIAs7IP2ee1Et0I' weight={300} height={300} /></p>


                            <h2 class="text-center">Present Perfect</h2>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item list-group-item-primary text-center">Чтобы поделиться недавними новостями, мы употребляем <em>Present Perfect</em>.</li>
                                <li class="list-group-item list-group-item-primary text-center">Действия, которые многократно повторялись до настоящего момента</li>
                                <li class="list-group-item list-group-item-primary text-center">Действия, которые начались в прошлом и все еще продолжаются</li>
                                <p class="p">Например:</p>
                                <li class="list-group-item list-group-item-success text-center"><em>I <strong>have already done</strong> my homework</em> — Я <strong>уже сделал</strong> домашнее задание</li>
                                <li class="list-group-item list-group-item-success text-center"><em>She<strong> has not finished</strong> her tasks</em> — Она <strong>не выполнила</strong> свои задачи</li>
                                <li class="list-group-item list-group-item-success text-center"><em><strong>Has</strong> she <strong>just arrived</strong> home?</em> — Она <strong>только что приехала</strong> домой?</li>
                            ...
                            <h2 class="text-center">Present Perfect Continuous </h2>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item list-group-item-success text-center"><em>Sorry, I <strong>haven’t been listening</strong> to you. Now I’m all ears.</em> — Извини, я тебя <strong>не слушала</strong>. Теперь я вся во внимании.</li>
                                <li class="list-group-item list-group-item-success text-center"><em><strong>Has</strong> he <strong>been watching</strong> series all day?</em> — Он что, <strong>смотрел</strong> сериалы весь день?</li>
